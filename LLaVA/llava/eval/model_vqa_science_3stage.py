...
def generate_rephrased_question(args, model, conv, tokenizer, images, image_sizes, instruction):
...
def evaluate_rephrased_question(args, model, conv, tokenizer, images, image_sizes, instruction, first_token=True):
...
def eval_model(args):
    ...
    for i, line in enumerate(tqdm(questions)):
        ...
        rephrased_question = generate_rephrased_question(args, model, conv, tokenizer, images, image_sizes, orig_qs)
        ...
        conv = conv_templates[args.conv_mode].copy()
        response1, base_state1 = evaluate_rephrased_question(args, model, conv, tokenizer, images, image_sizes, rephrased_question, first_token=False)
