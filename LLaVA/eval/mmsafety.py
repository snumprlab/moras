...
def main():
    ...
    for scenario in scenario_list:
        ...
        file_path = f"../datasets/safety/mmsafety/processed_questions/{scenario}.json"
        ...
        for data in tqdm(data_list):
            question = data_list[data]['Rephrased Question']
            img_path = f'../datasets/safety/mmsafety/images/{scenario}/SD_TYPO/{data}.jpg'
            ...
            output_dir = f'./results/{args.eval_model}/{args.mode}/mmsafety'
