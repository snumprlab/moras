...
def main():
    ...
    with open('../datasets/utility/mm-vet/mm-vet.json') as f:
    ...
    for data in tqdm(data_list):
        ...
        img_path = os.path.join('../datasets/utility/mm-vet/images', data_list[data]['imagename'])
        question = data_list[data]['question']
        ...
        with open(os.path.join(output_dir, f'mmvet.json'), 'w') as f:
