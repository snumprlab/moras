...
def main():
    ...
    questions = [json.loads(q) for q in open(os.path.expanduser('../datasets/utility/gqa/llava_gqa_testdev_balanced.jsonl'), "r")]
    questions = get_chunk(questions, 1, 0)
    answers_file = os.path.expanduser(f'./results/{args.eval_model}/{args.mode}/gqa.jsonl')
    ...
    for line in tqdm(questions):
        ...
        question = cur_prompt
        img_path = os.path.join('../datasets/utility/gqa/images', image_file)
